...
public class Rotation {
	public static void main(String args[]) {
		...
		System.out.println(Rotation.rotation("abcdef", 2));

	}

	/**
	 * Move {@code n} characters in front of given string to the end of string time
	...
	private static void rotation(char[] values, int n) {
